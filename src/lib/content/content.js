export const site_content = {
  ...
  Home: {
    Offers: {
      Title: "A Few Things We Can Help With",
      Offerings: [
        {
          Title: "Obedience",
          Details: [
    ...
    Classes: {
      Title: "Our Classes",
      Desc: "Utilizing a balanced training style that is modified to be the most ideal form of training for your dog, we strive to keep learning fun for dogs and accomplish your training goals in a timely manner. Your goals will become our goals!",
      Classes: [
        {
  ...
  FAQ: {
    "How often a day do you recommend working with your dog?":
      "I recommend working with your dog for 5-15 mins 1-3x a day. So if you have a busy day and all you have time for is a quick 5-minute session, great! Just have fun with your dog! As you progress with your training, everything you learn should become part of your everyday life and become second nature.",
    "How often should we meet for private lessons?":
      "Depends on how busy your life is and how old your dog is. For most adult dogs' I like to meet once a week while for puppies we like to meet every other week to give them time to work through the puppy goldfish brain. My main concern is whether you've accomplished your homework and if your dog is ready to move on to the next steps. So we can adjust the time between our lessons as needed.",
    "When can I join group classes?":
      "You're welcome to join group classes once you have approval from your trainer to join them. Dogs who need more confidence might join the confidence-building group before they even start private lessons' while others might not begin any group classes until after they've finished their private lessons. It fully depends on your dog and what they need.",
    "What if I want to continue group classes after my training packages?":
      "Awesome! After your package has been completed group classes are only $30 per. We have some clients who come once a week while others only stop in every so often for a refresher.",
    "What if I want to continue private lessons after my training package?":
      "Of course! We are here for the life of your dog so, if you ever have any problems or questions feel free to reach out! But if you need an add-on private lesson they are $125 per.",
    ...
    "Can I make payment plans?":
      "We try to ask for the payment upfront before training begins. But, we understand times are tough now, so we offer the option of paying 1/2 upfront and then the second half by the 3rd lesson.",
